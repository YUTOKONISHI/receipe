...
class ReceipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipe" do
    assert_difference('Receipe.count') do
      post receipes_url, params: { receipe: { image_path: @receipe.image_path, introduction: @receipe.introduction, receipe_category_id: @receipe.receipe_category_id, title: @receipe.title, user_id: @receipe.user_id } }
    end
  ...
  test "should update receipe" do
    patch receipe_url(@receipe), params: { receipe: { image_path: @receipe.image_path, introduction: @receipe.introduction, receipe_category_id: @receipe.receipe_category_id, title: @receipe.title, user_id: @receipe.user_id } }
